...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
  <!-- Brand Logo -->
   <a href="<?php echo $homelink; ?>" class="brand-link">
        ...
        <!-- Add icons to the links using the .nav-icon class
             ...
             <li class="nav-item">
              ...
              if (basename($_SERVER['PHP_SELF'])=="produit.php") {
               echo ' <a href="'.$productlink.'" class="nav-link active">
              ...
              echo '<a href="'.$productlink.'" class="nav-link">
              <i class="nav-icon fas fa-box-open"></i>
              <p>
                Produits
              </p>
          ...
          <li class="nav-item">
              ...
              if (basename($_SERVER['PHP_SELF'])=="cases.php") {
               echo ' <a href="'.$caseslink.'" class="nav-link active">
              ...
              echo '<a href="'.$caseslink.'" class="nav-link">
              <i class="nav-icon fa-solid fa-folder-tree  "></i>
              <p>
                Les Cas
              </p>
          ...
          <li class="nav-item">
              ...
              if (basename($_SERVER['PHP_SELF'])=="pricemanage.php") {
               echo ' <a href="'.$pricemanagelink.'" class="nav-link active">
              ...
              echo '<a href="'.$pricemanagelink.'" class="nav-link">
              <i class="nav-icon fa-solid fa-file-invoice-dollar"></i>
              <p>
              Gestion des prix
              </p>
          ...
          <?php 
              if (basename($_SERVER['PHP_SELF'])=="parametre.php") {
               echo ' <a href="'.$settingslink.'" class="nav-link active">
              ...
              echo '<a href="'.$settingslink.'" class="nav-link">
              <i class="nav-icon fa fa-gear"></i>
              <p>
              Paramètre
              </p>
